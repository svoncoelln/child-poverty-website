...
//   const myObj = {state: currentRow[0], FIPS: currentRow[1], district: currentRow[2], name: currentRow[3], population: currentRow[4], schoolAge: currentRow[5], kidsInPoverty: currentRow[6], povertyRate: (currentRow[6]/currentRow[5])}
//   objArray.push(myObj);
// }